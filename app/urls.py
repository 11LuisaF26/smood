...
from app import red_de_palabras
...
urlpatterns = [
    ...
    path('redes/campana/',  views.redes_sociales_filtro, name='redes_sociales_filtro'),
    ...
    path('red/twitter', red_de_palabras.render_graph, name='nube_de_palabras_twitter'),
